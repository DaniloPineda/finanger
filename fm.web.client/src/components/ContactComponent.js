...
class Contact extends Component {
    ...
    handleSubmit = (values) => {        
        ...
        this.props.postFeedbackForm(values.firstname, values.lastname, values.telnum,
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            <i className="fa fa-envelope"></i>: <a href="mailto:danilo.pineda@pevaar.com">danilo.pineda@pevaar.com</a>
                            </address>
                    </div>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum"  id="telnum" name="telnum"
                                            className="form-control" placeholder="Tel. Num"
                                            validators={{
